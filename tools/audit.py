...
# "funnel" is a separate, hand-authored artifact (the paid-ad lead funnel).
# It is not generated by tools/build.py and does not follow the brochure
# site's rules - it has its own end-to-end test. Auditing it here would
