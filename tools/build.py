...
<section class="section">
  <div class="wrap wrap--narrow">
    <div class="legal">
      ...
      <p>We also use the Meta Pixel, a tool from Meta Platforms (Facebook and Instagram), to measure
      how well our ads work and to show our ads to people who have visited this site. It records
      things like which pages you viewed and whether you sent us a quote request, and Meta may
      combine that with information it already has. Meta&rsquo;s own privacy policy covers how it
      uses that data. You can limit this in your Facebook or Instagram ad preferences, or by blocking
      third-party cookies in your browser.</p>
...
def main():
    ...
    NOT_GENERATED = {"funnel", "champaign-county-50-off", "assets", "tools", ".git", "node_modules"}
    stale = []
